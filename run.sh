...
echo
lattice-best-path ark:'gunzip -c exp/tri1/decode/lat.1.gz |' ark,t: | int2sym.pl -f 2- exp/tri1/graph/words.txt > exp/tri1/decoded_text.txt
echo
echo "===== Results from test data: ====="
echo
cat exp/tri1/decoded_text.txt
echo
